...
public class MakeCompatible {
	...
	/**
	 * @param args
	 *            args[0] path del train.arff args[1] path del test.arff o dev.arff
	 *            args[2] path del diccionario args[3] path para guardar el nuevo
	 *            fichero compatible
	 * @throws Exception
	 */
	public static void main(String[] args) {
		try {
			...
			System.err.println("No se ha podido hacer compatible");
		}
	}
